...
<!-- *********************************start database******************************* -->
    ...
    $result=mysqli_fetch_array($query,MYSQLI_ASSOC);
     ...
     echo $result['stwPrefix_id'];
     echo $result['stwFirstname'];
     echo $result['stwLastname'];
     echo $result['stwGender'];
     echo $result['stwEmail'];
     echo $result['stwTel'];
     echo $result['stwDept_id'];
     echo $result['stwStatus_id'];
     echo $result['stwActivate'];
    ?>
